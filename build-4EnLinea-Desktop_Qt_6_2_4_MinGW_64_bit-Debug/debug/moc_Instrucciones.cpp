...
QT_MOC_LITERAL(35, 0) // ""
    ...
    "Instrucciones\0botonAtrasPresionado\0"
};
...
void Instrucciones::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Instrucciones::botonAtrasPresionado)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Instrucciones, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
