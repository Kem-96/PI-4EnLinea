/****************************************************************************
** Meta object code from reading C++ file 'integrantes.h'
**
...
#include <memory>
#include "../../Connect4/integrantes.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'integrantes.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(12, 20), // "on_b_volverI_clicked"
QT_MOC_LITERAL(33, 0) // ""

    },
    "Integrantes\0on_b_volverI_clicked\0"
};
...
void Integrantes::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_b_volverI_clicked(); break;
        default: ;
        }
    }
    (void)_a;
